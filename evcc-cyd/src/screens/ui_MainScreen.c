...
void ui_MainScreen_screen_init(void)
{
    ...
    lv_label_set_text(ui_lblReichweite, "Actieradius                km");
    ...
    lv_label_set_text(ui_lblRestzeit, "Rest. laadtijd              h");
    ...
    lv_label_set_text(ui_lblLadelimit, "Laadlimiet");
    ...
    lv_label_set_text(ui_txtBtnModusPlan, "Min+PV");
    ...
    lv_label_set_text(ui_txtBtnModusNow, "Snel");
